...
public class AddDefect extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rtoobar.setTitle("Додайте новий дефект");
            ...
            filePath.putFile(postImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    if (!TextUtils.isEmpty(defectName) &&
                        ...
                        Toast.makeText(AddDefect.this, "Завантажено !!!", Toast.LENGTH_SHORT).show();
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(AddDefect.this, "Заповніть всі поля та повторіть спробу", Toast.LENGTH_LONG).show();
                    }
                ...
                public void onProgress(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    progressDialog.setMessage("Завантажено " + progress + " %");

                }
            });

        } else {
            Toast.makeText(AddDefect.this, "Будь ласка, виберіть малюнок!", Toast.LENGTH_LONG).show();
        }
    }
